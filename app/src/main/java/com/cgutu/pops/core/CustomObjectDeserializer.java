 ...
 */
public abstract class CustomObjectDeserializer<T> implements ParentJsonDeserializer<T> {
	...
	/**
	 * We need to set the root String to get the object of the root associated
	 *
